...
namespace EmojiUI
{
    public class EmojiRenderGroup : IEmojiRender
    {
                                ...
                                for (int j = 0; j < emojidata.Count; ++j)
                                {
                                    ...
                                    if (groupinfo != null && groupinfo.spritegroups.Count > 1)
                                    {
                                        ...
                                        if (group != null)
                                        {
                                            ...
                                            RefreshSubUIMesh(text, group, asset, taginfo._Pos, taginfo._UV, joblist);
        ...
        Graphic Parse(InlineText text, SpriteTagInfo taginfo, List<string> joblist)
        {
            if (taginfo != null)
            {
